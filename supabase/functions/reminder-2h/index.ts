// supabase/functions/reminder-2h/index.ts
// Supabase Edge Function - Cron: every hour
// Sends courtesy WhatsApp reminders 2 hours before the appointment
...
serve(async () => {
    try {
        ...
        // Find appointments between 1.5 and 2.5 hours from now
        const now = new Date();
        ...
        for (const cita of citas || []) {
            ...
            await sendWhatsApp(
                ...
                `⏰ ¡Hola ${cita.clientes.nombre}! Es un recordatorio de cortesía: tienes cita en *Keroal* en 2 horas.\n\n` +
